...
// *book's text, you MUST initialize the ticker only once multitasking has started.
// *
...
//   // BSP_LED_Off(0u);                                            /* Turn Off
//   // LEDs after initialization                   */
...
//     OSTaskCreate(
//         pTask_Cfg->pTcb, pTask_Cfg->name, pTask_Cfg->func, (void *)0u,
//         pTask_Cfg->prio, pTask_Cfg->pStack,
//         pTask_Cfg->pStack[APP_CFG_TASK_START_STK_SIZE / 10u],
//         APP_CFG_TASK_START_STK_SIZE, (OS_MSG_QTY)0u, (OS_TICK)0u, (void *)0u,
